...
const AvatarUpdateDialog = ({ reducer }) => {
    AvatarUpdateDialog.propTypes = {
    ...
    const handleClose = () => {
        setErrorMessage("");
        dispatch(setShowAvatarUpdateDialog(false));
    };
    ...
    return (
        <Dialog open={showAvatarUpdateDialog} onClose={handleClose} fullWidth>
            <Box
                display="flex"
